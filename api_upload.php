...
/**
 * api_upload.php
 * Standart Fotoğraf Yükleme | %60 Küçültme | TRAFİK KOTASI VE SOFT-LİMİT KONTROLÜ EKLENDİ
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['photos'])) {
    ...
    // Kural: Trafik Kotası = (Depolama Limiti * 10) + Ek Trafik Limiti
    ...
    if ($trafik_limiti_byte > 0 && $yeni_kullanim_byte > $trafik_limiti_byte) {
        ...
        if ($firmaBilgi['trafik_asim_tarihi']) {
            ...
            // İlk kez aşıldıysa şuanın tarihini atıyoruz (Tolerans süresi başlıyor)
    ...
    $uploaded_count = 0;
    $errors = [];
    $scaleRatio = 0.40; // %60 Küçültme (Orijinalin %40'ı kalır)
    $jpegQuality = 80;
